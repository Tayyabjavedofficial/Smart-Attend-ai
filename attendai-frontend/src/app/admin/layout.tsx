...
import {
  ...
  AlertTriangle, ShieldCheck, FileBarChart, Settings, Megaphone, Bell, LifeBuoy,
} from "lucide-react";
...
const nav: NavItem[] = [
  ...
  { href: "/admin/alerts", label: "Proxy Alerts", icon: AlertTriangle, badge: 5, section: "Security" },
